...
<html lang="en-us">
	<head>
		...
		<title> <?php echo $page_title != "" ? $page_title." - " : ""; ?>InvisoVideo </title>
			...
			-->
					...
					<div class="pull-right">
						...
						<div id="logout" class="btn-header transparent pull-right">
							<span> <a href="<?php echo APP_URL; ?>/login.php" data-action="userLogout" title="Sign Out" data-logout-msg="You can improve your security further after logging out by closing this opened browser"><i class="fa fa-sign-out"></i></a> </span>
						</div>
						<!-- end logout button -->
						...
						<div id="fullscreen" class="btn-header transparent pull-right">
							<span> <a href="javascript:void(0);" onClick="launchFullscreen(document.documentElement);" data-action="launchFullscreen" title="Full Screen"><i class="fa fa-arrows-alt"></i></a> </span>
						</div>
						...
						<!-- snapshot button 
						<div id="snapshot" class="btn-header transparent pull-right" style="margin-right: 20px;">
							<span> <a href="http://nvradmin:inviso@50.133.34.33:9191/axis-cgi/jpg/image.cgi" target="_blank"><i class="fa fa-camera"></i></a>	</span>
						</div>
						<!-- end snapshot button -->
						...
						<ul class="header-dropdown-list hidden-xs">
							<li>
								<a href="#" class="dropdown-toggle" style="margin-right: 20px;" data-toggle="dropdown"> <img alt="" src="<?php echo ASSETS_URL; ?>/img/flags/us.png"> <span> US </span> <i class="fa fa-angle-down"></i> </a>
				...
				<div id="shortcut">
					<ul>
						<li>
							<a href="<?php echo APP_URL; ?>/users.php" class="jarvismetro-tile big-cubes bg-color-blue"> <span class="iconbox"> <i class=""></i> <span> Users </span> </span> </a>
						</li><!--/nvr.php"-->
						<li>
							<a href="<?php echo APP_URL; ?>/sites.php" class="jarvismetro-tile big-cubes bg-color-orangeDark"> <span class="iconbox"> <i class="fa fa--o fa-4x"></i> <span> Sites </span> </span> </a>
						</li><!--/admin.php"-->
						<li>
							<a href="<?php echo APP_URL; ?>/cameras.php" class="jarvismetro-tile big-cubes bg-color-purple"> <span class="iconbox"> <i class="fa fa--o fa-4x"></i> <span> Cameras </span> </span> </a>
						</li>
						<li>
							<a href="<?php echo APP_URL; ?>/#" class="jarvismetro-tile big-cubes bg-color-blueDark"> <span class="iconbox"> <i class=""></i> <span> Settings </span> </span> </a>
						</li>
						<li>
							<a href="<?php echo APP_URL; ?>/#" class="jarvismetro-tile big-cubes bg-color-greenLight"> <span class="iconbox"> <i class=""></i> <span> My Account </span> </span> </a>
						</li>
						<li>
							<a href="<?php echo APP_URL; ?>/speedtest/index.php" class="jarvismetro-tile big-cubes bg-color-greenLight"> <span class="iconbox"> <i class=""></i> <span> Speed Test </span> </span> </a>
						</li>
					</ul>
				</div>
				<!-- END SHORTCUT AREA -->
