					...
					<div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-collapsed="false">
						...
						<div>
							...
							if ( !empty($_POST) ) {
							    ...
							    $updated = $site_obj->update_site($site_id, $site_data);

							    if( $updated ) header("Location:view_sites.php?id=$user_id");

							} //$_POST
							$site_id  = $_REQUEST['site_id']; //the user id
								...
								<form class="form-horizontal" action="" method="post">
									...
									<fieldset>
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												<input id="description" name="description" value="<?php echo $description ?>" class="form-control" placeholder="Site Description" type="text" required>
											</div>
										</div>																		
									</fieldset>	
